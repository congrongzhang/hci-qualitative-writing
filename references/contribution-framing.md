# HCI Contribution Framing

Use this guide to identify, name, and test the paper's contribution.

## Contribution chain

Build the contribution through six linked statements:

1. **Phenomenon:** What consequential human-technology practice, relation, or change does the paper examine?
2. **Problem in understanding:** What can the relevant HCI community currently explain, and where does that explanation become incomplete, imprecise, or poorly transferable?
3. **Empirical advance:** What pattern, process, relation, mechanism, tension, or boundary does the analysis establish?
4. **Conceptual move:** What does the paper name, distinguish, connect, reframe, refine, or explain?
